      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!originalImage && (
          <div id="mode-selection" className={cn("grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 max-w-4xl mx-auto scroll-mt-24", !mode ? "mt-12" : "")}>
            <Card 
              className={cn(
                "cursor-pointer transition-all duration-300 hover:shadow-xl border-2 hover:-translate-y-1 overflow-hidden focus-visible:ring-4 focus-visible:ring-indigo-500/50 focus-visible:outline-none",
