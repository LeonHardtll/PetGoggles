      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto px-4">
        <Card className="bg-orange-50 border-orange-100">
          <CardContent className="p-6">
            <div
              className="flex items-center gap-1 mb-4 text-orange-400"
              role="img"
              aria-label="5 out of 5 stars"
            >
              <Star className="fill-current w-4 h-4" aria-hidden="true" />
              <Star className="fill-current w-4 h-4" aria-hidden="true" />
              <Star className="fill-current w-4 h-4" aria-hidden="true" />
              <Star className="fill-current w-4 h-4" aria-hidden="true" />
              <Star className="fill-current w-4 h-4" aria-hidden="true" />
        ...
        <Card className="bg-purple-50 border-purple-100">
          <CardContent className="p-6">
            <div
              className="flex items-center gap-1 mb-4 text-purple-400"
              role="img"
            ...
            <div className="flex items-center gap-3">
              <img
                src="https://images.unsplash.com/photo-1513245543132-31f507417b26?auto=format&fit=crop&q=80&w=100"
                className="w-10 h-10 rounded-full object-cover border-2 border-white shadow-sm"
                alt="Luna"
              />
              <div>
