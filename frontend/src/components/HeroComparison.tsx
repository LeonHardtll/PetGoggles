  ...
  return (
    <div className="relative w-full max-w-[500px] mx-auto lg:mx-0 select-none group">
      ...
      <div
        ...
        className="absolute -top-6 left-1/2 -translate-x-1/2 z-30 flex items-center gap-1 bg-white/90 backdrop-blur shadow-sm border border-slate-200 rounded-full p-1 mb-4"
      >
        <button
          onClick={() => setActiveMode('dog')}
          aria-pressed={activeMode === 'dog'}
          className={cn(
            "flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-bold transition-all focus-visible:ring-2 focus-visible:ring-orange-400 focus-visible:outline-none",
            activeMode === 'dog' 
        ...
        <button
          ...
          aria-pressed={activeMode === 'cat'}
          className={cn(
            "flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-bold transition-all focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:outline-none",
            activeMode === 'cat' 
      ...
      >
        ...
        >
             <img 
                ...
                alt={activeMode === 'dog' ? "Dog Vision" : "Cat Vision"}
             />
        ...
        <div 
            ...
            className="absolute top-0 bottom-0 w-1 bg-white cursor-col-resize z-20 shadow-[0_0_10px_rgba(0,0,0,0.3)] focus-visible:ring-4 focus-visible:ring-blue-400/50 focus-visible:outline-none transition-shadow"
