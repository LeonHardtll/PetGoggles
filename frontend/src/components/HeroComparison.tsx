    ...
    <div className="relative w-full max-w-[500px] mx-auto lg:mx-0 select-none group">
      ...
      >
        ...
        <div 
            ...
            className="absolute top-0 bottom-0 w-1 bg-white cursor-col-resize z-20 shadow-[0_0_10px_rgba(0,0,0,0.3)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-500"
